    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                ...
                <div class="app-sidebar__heading"><a class="text-decoration-none" href="/quantri">DphoneS</a></div>
                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="assets/images/user/{{ Auth::guard('admin')->user()->avatar ?? '' }}" alt="">
                                ...
                                <div class="widget-content-left  ml-3 header-user-info">
                                    ...
                                    <div class="widget-subheading">
                                        @if(Auth::guard('admin')->user()->level == 0) Host
                                        @elseif(Auth::guard('admin')->user()->level == 1) Admin
                                        @endif
                                    </div>
                                </div>
                            </div>
