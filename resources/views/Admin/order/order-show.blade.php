    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="/quantri/order/edit/{{$order->id}}" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                        ...
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                            ...
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-3">
                                                    <div class="widget-content-left">
                                                        <img style="height: 60px;" data-toggle="tooltip" title="Image" data-placement="bottom" src="assets/images/products/{{ $orderDetail->product->productImage[0]->path }}" alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <td class="text-center">
                                        ${{ number_format($orderDetail->amount, 0, ',', '.') }}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
